...
class TestDiagnostics:
    ...
    def mock_coordinator(self):
        ...
        coordinator.data = {
            "device1": {
                ...
                "battery_level": 85,
                "gps_accuracy": 3.2,
                "last_seen": datetime(2023, 8, 21, 10, 30, 0, tzinfo=UTC),
                "asset_info": {
                    "brand": "BMW",
                    "model": "X3",
                    "serial": "ABC123",
            ...
            "device2": {
                ...
                "battery_level": None,
                "gps_accuracy": 5.1,
                "asset_info": {"brand": "Giant", "model": "TCR", "type": 2},
            },
        }
    ...
    @pytest.mark.asyncio
    async def test_config_entry_diagnostics_with_exception(
        self, hass: HomeAssistant, mock_config_entry, mock_coordinator
    ):
    ...
    @pytest.mark.asyncio
    async def test_device_diagnostics_no_coordinator(
